# E1T4 — Show available time slots

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 TBLBOT

Display available time slots based on table inventory and existing bookings. Write tests to tests/specs/E1T4.json and append to tests/commands.json.
