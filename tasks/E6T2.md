# E6T2 — Table allocation algorithm

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 TBLBOT

Implement table-first-fit allocation to prevent overbooking. Write tests to tests/specs/E6T2.json and append to tests/commands.json.
