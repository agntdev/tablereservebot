# E9T2 — No available slots handling

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 TBLBOT

Suggest nearest available times when no slots exist. Write tests to tests/specs/E9T2.json and append to tests/commands.json.
