# E1T5 — Guest confirmation flow

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 TBLBOT

Collect guest name and phone (optional), then confirm booking with reference code and inline buttons. Write tests to tests/specs/E1T5.json and append to tests/commands.json.
