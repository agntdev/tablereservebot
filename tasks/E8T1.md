# E8T1 — Admin authentication system

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 TBLBOT

Restrict owner commands to configured admin Telegram IDs. Write tests to tests/specs/E8T1.json and append to tests/commands.json.
