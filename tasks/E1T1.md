# E1T1 — Implement /start command and greeting

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 TBLBOT

Add /start command that shows a brief greeting and explains the reservation steps. Write tests to tests/specs/E1T1.json and append to tests/commands.json.
