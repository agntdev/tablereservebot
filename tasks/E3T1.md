# E3T1 — Cancel command and confirmation

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 TBLBOT

Add /cancel command with confirmation dialog. Write tests to tests/specs/E3T1.json and append to tests/commands.json.
