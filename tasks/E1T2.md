# E1T2 — Date selection with calendar

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 TBLBOT

Implement calendar-based date selection for guests. Write tests to tests/specs/E1T2.json and append to tests/commands.json.
