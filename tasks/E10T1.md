# E10T1 — Rename 'About' and 'Help' buttons to clarify their purposes

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 TBLBOT

Change the first two buttons in the /start message from 'About' and 'Help' to more descriptive labels like 'How to Reserve' and 'Need Assistance?' to make their functions immediately clear to users.
