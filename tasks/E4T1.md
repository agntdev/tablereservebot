# E4T1 — Implement /today command

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 TBLBOT

Add /today command to show remaining capacity and bookings. Write tests to tests/specs/E4T1.json and append to tests/commands.json.
