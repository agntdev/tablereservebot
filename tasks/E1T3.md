# E1T3 — Party size input

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 TBLBOT

Add party size selection via quick buttons or numeric input. Write tests to tests/specs/E1T3.json and append to tests/commands.json.
