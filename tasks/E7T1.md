# E7T1 — Database schema and indexes

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 TBLBOT

Create tables for owners, settings, table inventory, bookings, and allocation details with proper indexes. Write tests to tests/specs/E7T1.json and append to tests/commands.json.
