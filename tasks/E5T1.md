# E5T1 — Reminder scheduling system

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 TBLBOT

Create background worker to send configurable reminders before bookings. Write tests to tests/specs/E5T1.json and append to tests/commands.json.
