# E4T3 — Implement /booking command

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 TBLBOT

Add /booking <ref> command to show booking details and allow admin actions. Write tests to tests/specs/E4T3.json and append to tests/commands.json.
