# E4T4 — Implement /mark_noshow command

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 TBLBOT

Add /mark_noshow <ref> command to update booking status. Write tests to tests/specs/E4T4.json and append to tests/commands.json.
