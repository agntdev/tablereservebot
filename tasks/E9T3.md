# E9T3 — Concurrency control

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 TBLBOT

Implement DB transactions and optimistic locking for booking operations. Write tests to tests/specs/E9T3.json and append to tests/commands.json.
