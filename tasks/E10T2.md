# E10T2 — Add tooltip/explanation for 'Setting' button

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 TBLBOT

Add a brief tooltip or inline explanation in the /start message that clarifies the 'Setting' button is for restaurant owners to configure settings (opening hours, table inventory, etc.) and is only visible to admin accounts.
