# fix-c157a2fdb0cf2532 — Fix: Failing dialog spec: /book confirms a valid reservation and allocateFirstFit rejects when existing bookings consume capacity
