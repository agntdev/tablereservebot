# E4T2 — Implement /upcoming command

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 TBLBOT

Add /upcoming command to list bookings for next N days. Write tests to tests/specs/E4T2.json and append to tests/commands.json.
