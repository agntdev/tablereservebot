# fix-77c72623fa9677f3 — Fix: Failing dialog spec: /book interactive mode clears prior calendar-flow session state so guest name is not intercepted by awaitingPartySize
