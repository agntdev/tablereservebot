# E5T2 — No-show status tracking

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 TBLBOT

Track no-shows and update stats after admin marks them. Write tests to tests/specs/E5T2.json and append to tests/commands.json.
