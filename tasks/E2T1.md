# E2T1 — Reschedule command and slot swap

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 TBLBOT

Add /reschedule command that shows available slots after freeing current booking. Write tests to tests/specs/E2T1.json and append to tests/commands.json.
