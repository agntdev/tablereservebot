# E6T1 — Slot generation with opening hours

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 TBLBOT

Generate candidate start times within configured opening hours and slot increments. Write tests to tests/specs/E6T1.json and append to tests/commands.json.
